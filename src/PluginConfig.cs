...
internal sealed class PluginConfig
{
    ...
    public static PluginConfig Bind(ConfigFile cfg)
    {
        var c = new PluginConfig
        {
            ...
            Encoder = cfg.Bind("Recording", "Encoder", "Auto",
                new ConfigDescription("Encoder backend. Auto: probe NVENC->AMF->QSV, fall back to software (x264/x265) if none initializes. Software: always libx264/libx265. NVENC/AMF/QSV: force a specific hardware encoder (fails the take if unavailable).",
